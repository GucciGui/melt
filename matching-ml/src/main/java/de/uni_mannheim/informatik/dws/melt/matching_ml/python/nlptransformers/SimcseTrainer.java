 ...
 */
public class SimcseTrainer extends TransformersBaseFineTuner {
     ...
     */
    public SimcseTrainer(TextExtractorMap extractor, String initialModelName, File resultingModelLocation) {
        super(extractor, initialModelName, resultingModelLocation);
        this.testSize = 0.33f;
        this.trainBatchSize = 64;
        this.testBatchSize = 32;
        this.numberOfEpochs = 5;
        this.loss = SentenceTransformersLoss.MultipleNegativesRankingLoss;
    }
     ...
     * @param resultingModelLocation the final location where the fine-tuned model should be stored.
     */
    public SimcseTrainer(TextExtractor extractor, String initialModelName, File resultingModelLocation) {
    ...
    public File finetuneModel(File trainingFile) throws PythonServerException {
        PythonServer.getInstance().simcseTraining(this, trainingFile, null);
    ...
    public float finetuneModel(File trainingFile, File validationFile) throws PythonServerException {
        return PythonServer.getInstance().simcseTraining(this, trainingFile, validationFile);
    }
